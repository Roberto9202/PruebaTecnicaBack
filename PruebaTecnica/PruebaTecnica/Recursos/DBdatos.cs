...
namespace PruebaTecnica.Recursos
{
    public class DBdatos
    {
        ...
        public static DataTable ListarEstudios(string nombreProcedimiento)
        {
            SqlConnection conexion = new SqlConnection(cadenaConexion);
        ...
        public static DataTable ObtenerSucursalEstudios(string nombreProcedimiento, List<Parametro> parametros = null)
        {
            SqlConnection conexion = new SqlConnection(cadenaConexion);
